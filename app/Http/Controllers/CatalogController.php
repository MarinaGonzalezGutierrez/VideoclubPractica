...
class CatalogController extends Controller
{
	...
	//metodo show -> mostrar pero desde la tabla
	//metodo edit -> mostrar 1 pelicula desde la tabla
	//metodo insert -> insertar pelicula tabla
	//metodo edit -> modificar los datos de 1 pelicula
